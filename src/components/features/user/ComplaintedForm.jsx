...
const ComplaintedForm = () => {
  return (
    <main className="flex flex-col items-center pt-12 h-[673px]">
      <h1 className="mb-10 text-3xl font-semibold">Khiếu nại sản phẩm</h1>
        ...
        <div className="mt-28">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-zinc-800">
              Quý khách đã khiếu nại sản phẩm thành công
            </p>
          </div>
        </div>
      </section>
...
export default ComplaintedForm;
...
export default function HomepageGroup3207() {
  return (
    <div className="self-stretch">
      <div className="flex justify-center bg-white-a700 py-11 md:py-5 sm:py-4">
        <div className="container-xs mt-3.5 flex justify-center px-14 lg:px-5 md:px-5">
          <div className="ml-1.5 flex w-[82%] gap-[130px] lg:ml-0 md:ml-0 md:flex-col">
            <Suspense fallback={<div>Loading feed...</div>}>
              {data.map((d, index) => (
                <ProductSupportInfo {...d} key={"group5231" + index} />
              ))}
            </Suspense>
          </div>
        </div>
